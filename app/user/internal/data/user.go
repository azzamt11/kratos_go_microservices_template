...
func NewUserRepo(data *Data, logger log.Logger) biz.UserRepo {
	return &userRepo{ //This line is complaining. cannot use &userRepo{…} (value of type *userRepo) as biz.UserRepo value in return statement: *userRepo does not implement biz.UserRepo (missing method Delete)
		data: data,
